const defaultDataset = {
  "init": {
      answers: [
          {content: "いつまでも健康で長生きする", nextId: "job_offer"},
          {content: "定年後エンジニアになる！", nextId: "consultant"},
          {content: "もっともっとプログラミングを勉強したい", nextId: "community"},
          {content: "家族を大事にする！", nextId: "dating"},
      ],
      question: "こんにちは！最強の係長の今後の目標は？",
  },
  "job_offer": {
      answers: [
